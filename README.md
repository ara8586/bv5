...
cd $HOME
git clone https://github.com/ara8586/bv5.git
cd bv5
chmod +x beyond.sh
./beyond.sh install
./beyond.sh 
...
```sh
cd $HOME && git clone https://github.com/ara8586/bv5.git && cd bv5 && chmod +x beyond.sh && ./beyond.sh install && ./beyond.sh

OR

cd $HOME && git clone https://github.com/ara8586/bv5.git && cd bv5 && chmod +x beyond.sh && ./beyond.sh install && chmod 777 autobd.sh && screen ./autobd.sh
```
